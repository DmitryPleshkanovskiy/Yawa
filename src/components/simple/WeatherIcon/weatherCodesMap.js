export const weatherCodeMap = {
  weatherCode: {
    0: { description: "Unknown", icon: "na", color: "shadow" },
    1000: { description: "Clear, Sunny", icon: "wi-day-sunny", color: "warm" },
    1100: { description: "Mostly Clear", icon: "wi-day-sunny", color: "warm" },
    1101: {
      description: "Partly Cloudy",
      icon: "wi-day-cloudy",
      color: "warm",
    },
    1102: { description: "Mostly Cloudy", icon: "wi-cloud", color: "shadow" },
    1001: { description: "Cloudy", icon: "wi-cloudy", color: "shadow" },
    2000: { description: "Fog", icon: "wi-fog", color: "shadow" },
    2100: { description: "Light Fog", icon: "wi-fog", color: "shadow" },
    4000: { description: "Drizzle", icon: "wi-rain-mix", color: "wet" },
    4001: { description: "Rain", icon: "wi-rain-mix", color: "wet" },
    4200: { description: "Light Rain", icon: "wi-sleet", color: "wet" },
    4201: { description: "Heavy Rain", icon: "wi-rain", color: "wet" },
    5000: { description: "Snow", icon: "wi-day-snow", color: "cold" },
    5001: { description: "Flurries", icon: "wi-snow", color: "cold" },
    5100: { description: "Light Snow", icon: "wi-snow", color: "cold" },
    5101: {
    ...
    6001: { description: "Freezing Rain", icon: "wi-hail", color: "cold" },
    6200: {
    ...
    7000: { description: "Ice Pellets", icon: "wi-snow-wind", color: "cold" },
    7101: {
